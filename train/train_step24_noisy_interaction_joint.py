...
from train.train_step6_noisy_rewrite_finetune import build_rewrite_model, compute_noisy_selection_score
...
def main() -> None:
    ...
    parser.add_argument("--save_dir", type=str, default="checkpoints/step24_noisy_interaction_joint")
    ...
    if "obs_node_feats" not in sample or "obs_adj" not in sample:
        raise KeyError("Step 24 expects noisy Step 22/23 transition samples with obs_node_feats/obs_adj.")
        ...
        if selection_score > best_score:
            ...
            save_json(
                best_metrics_path,
                {
                    ...
                    "val_noisy_results": val_noisy_results,
                    "args": ckpt_args,
                    "coupling_regime": "light_joint_noisy_interaction",
